...
import { WebsiteListing, ApplicationListing, WorkflowTypes, WorkflowUrls } from "../../types";
...
export const WorkflowComponentItem: FC<Props> = ({deleteListing, component}) => {
    const formattedName = niceName[formatCasing(component.__typename) as keyof WorkflowTypes];
    const urlName = urlFriendlyNames[formatCasing(component.__typename) as keyof WorkflowUrls];
